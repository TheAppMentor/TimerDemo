...
//            theDataSet.axisDependency = .right
    ...
    func makeBarChart(frame: CGRect, chartData: [String: Double]? = nil, vizType: TypeOfViz, taskName: String? = nil, dataPointLimit: Int, completionH : @escaping (_ theChartView: UIView, _ chartTitle: String)->Void) {
