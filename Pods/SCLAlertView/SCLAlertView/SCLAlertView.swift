...
let kCircleHeightBackground: CGFloat = 75.0
...
open class SCLAlertView: UIViewController {
    ...
    public struct SCLAppearance {
        ...
        public init(kDefaultShadowOpacity: CGFloat = 0.75, kCircleTopPosition: CGFloat = -12.0, kCircleBackgroundTopPosition: CGFloat = -15.0, kCircleHeight: CGFloat = 55.0, kCircleIconHeight: CGFloat = 30.0, kTitleTop:CGFloat = 60.0, kTitleHeight:CGFloat = 25.0, kWindowWidth: CGFloat = 240.0, kWindowHeight: CGFloat = 178.0, kTextHeight: CGFloat = 90.0, kTextFieldHeight: CGFloat = 45.0, kTextViewdHeight: CGFloat = 80.0, kButtonHeight: CGFloat = 45.0, kTitleFont: UIFont = UIFont.systemFont(ofSize: 20), kTextFont: UIFont = UIFont.systemFont(ofSize: 14), kButtonFont: UIFont = UIFont.boldSystemFont(ofSize: 14), showCloseButton: Bool = true, showCircularIcon: Bool = true, shouldAutoDismiss: Bool = true, contentViewCornerRadius: CGFloat = 15.0, fieldCornerRadius: CGFloat = 3.0, buttonCornerRadius: CGFloat = 8.0, hideWhenBackgroundViewIsTapped: Bool = false, contentViewColor: UIColor = UIColorFromRGB(0xFFFFFF), contentViewBorderColor: UIColor = UIColorFromRGB(0xCCCCCC), titleColor: UIColor = UIColorFromRGB(0x4D4D4D)) {
    ...
    override open func viewWillLayoutSubviews() {
        ...
        // Subtitle
        y = appearance.kTitleTop + appearance.kTitleHeight + titleOffset + 20
        ...
        for btn in buttons {
            btn.frame = CGRect(x:appearance.kWindowWidth/2.0 - ((appearance.kWindowWidth/1.5)/2.0)  , y:y, width:appearance.kWindowWidth/1.5, height:50)
            btn.layer.cornerRadius = appearance.buttonCornerRadius
            y += appearance.kButtonHeight + 20
        }
    }
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        ...
        if appearance.showCloseButton {
          //  _ = addButton(completeText ?? "Done", target:self, selector:#selector(SCLAlertView.hideView))
            _ = addButton("Cancel", backgroundColor: contentView.backgroundColor, textColor: UIColor.lightGray, showDurationStatus: false, target: self, selector: #selector(SCLAlertView.hideView))
        }
        ...
        if style == .wait {
            ...
            if let iconTintColor = iconTintColor {
                ...
                circleIconView = UIImageView(image: #imageLiteral(resourceName: "Focus Swamy White"))
            }
        }
