...
static const CGFloat kBorderWidth = .0 * kScale;
static const CGFloat kSize = kBorderSize + kBorderWidth; // The total size is the border size + 2x half the border width.
static const CGFloat kPauseLineWidth = 5.0 * kScale;
static const CGFloat kPauseLineHeight = 25.0 * kScale;
static const CGFloat kPauseLinesSpace = 8.0 * kScale;
